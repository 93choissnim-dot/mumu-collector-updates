...
class TransitionTests(unittest.TestCase):
    ...
    def test_animation_rejects_input_then_rechecks_free_key_and_completes(self):
        ...
        c.daily_ready=Mock(side_effect=[free,enter,done])
        c.screen=Mock(side_effect=[page('unknown'),free,free,enter]);c.daily_combat.return_value=(done,True)
    ...
    def test_fight_waits_for_counter_after_rejected_preinput_without_duplicate(self):
        ...
        c.daily_combat.return_value=(done,True)
