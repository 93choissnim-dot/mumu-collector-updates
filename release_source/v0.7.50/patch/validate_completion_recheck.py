"""Old completion records require a read-only audit on an explicit retry."""
import tempfile
import threading
import unittest
...
class CompletionRecheckTests(unittest.TestCase):
    def setUp(self):
        ...
        c.manual_retry_tasks={'daily_dungeons'};c.daily_recover=Mock()
    ...
    def test_verified_new_completion_is_preserved(self):
        c=self.c;c.daily_checkpoint('done',completion_evidence={'revision':1,'kind':'no_entries','observations':2,'page':'daily_room_rune'})
