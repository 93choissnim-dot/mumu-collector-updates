...
class TopBarVision:
    ...
    def recognize(self,image):
        ...
        for key,(ref,box) in self.references.items():
            ...
            # The expanded pass mask includes moving snow/terrain around the
            # emblem. Also test its original foreground, with unchanged gates.
            for candidate in ((mask,core) if key=='pass' else (mask,)):
                ...
                a=gray[yy:yy+h,xx:xx+w][candidate>0];t=template[candidate>0]
