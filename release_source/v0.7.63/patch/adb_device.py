...
class InputNotSent(Halt):
    """A local pre-dispatch guard rejected the touch; no ADB input was sent."""
...
class AdbDevice:
    ...
    def click(self, point):
        try:
            ...
            if isinstance(exc, ResumeRecognition):raise
            raise InputNotSent(str(exc)) from exc
