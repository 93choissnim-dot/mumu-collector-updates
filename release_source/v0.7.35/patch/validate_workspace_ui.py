...
def check(app,output):
    ...
    for scale in (1.25,1.5):
        ...
        for widget in [app.start_button,app.once_button,app.stop_button,app.pause_button,app.filter_menu,app.update_button]:
    ...
    assert app.detail_panel.winfo_width()>app.roster_panel.winfo_width()
