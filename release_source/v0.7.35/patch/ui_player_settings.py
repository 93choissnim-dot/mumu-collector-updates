...
TASK_HELP={
    ...
    'daily_pass':'하루 1회 · 멤버십 보상',
    'daily_dungeons':'하루 1회 · 2종 소탕, 5종 입장',
    'daily_guild':'하루 1회 · 기부 최대 루비 150 포함',
}
...
class PlayerSettings:
    ...
    def select(self,ident):
        ...
        label(self.body,'일일 작업은 KST 00:00에 초기화됩니다.',size=10,color=MUTED).grid(row=5,column=0,sticky='w',padx=18,pady=(0,10))
        ...
        label(identity,'같은 뮤뮤에서 계정을 바꿀 때 함께 변경해 주세요.\n구분별로 일일 완료 기록을 보관합니다. 비우면 기존 기록을 사용합니다.',size=10,color=MUTED,wraplength=330,justify='left').grid(row=2,column=0,sticky='w',padx=12,pady=(6,10))
