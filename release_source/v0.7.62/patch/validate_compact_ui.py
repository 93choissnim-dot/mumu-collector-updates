...
def check(app,output):
    ...
    for scale in (1.,1.25,1.5):
        ...
        for widget in (app.once_button,app.start_button,app.scope_selector,app.connect_button,app.update_button,app.more_button,app.detail_name,app.connection_badge):
