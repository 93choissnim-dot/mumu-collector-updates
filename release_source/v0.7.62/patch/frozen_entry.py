...
def health_check(output,full_ui=True):
    ...
    output.write_text(json.dumps({'ok':True,'version':VERSION,'frozen':bool(getattr(sys,'frozen',False)),
        ...
        'network_dialog_recovery':True,'independent_game_watch':True,'startup_confirmation':True,'session_workflow':True,'game_exit_recovery':True,'workflow_ui':full_ui,'compact_reliability':True,'compact_ui':full_ui,'free_only_guild':True,'worldboss_plan':True,'update_retry':True,
