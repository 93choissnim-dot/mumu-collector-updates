...
def check(app,output):
    ...
    for scale in (1.25,1.5):
        ...
        root.geometry('980x640+0+0');root.update();app.render_roster(force=True);root.update()
        for widget in [app.start_button,app.once_button,app.stop_button,app.pause_button,app.inspect_button,app.filter_menu]:
    ...
    ctk.set_widget_scaling(1);ctk.set_window_scaling(1);root.geometry('980x640+0+0');root.update()
