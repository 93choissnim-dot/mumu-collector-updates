    ...
    def render_roster(self,force=False,working=None):
        ...
        if signature!=self.roster_signature:
            ...
            for i,ident in enumerate(ids):
                ...
                status=label(row,'',size=10,width=76,height=24,corner_radius=2,fg_color=INSET)
        ...
        for ident,widgets in self.roster_rows.items():
            ...
            update(widgets['status'],text=state['status'],text_color=TONES[state['tone']],fg_color=TINTS[state['tone']])
