...
class PlayerSettings:
    def __init__(self,app,initial=None):
        ...
        nav=ctk.CTkScrollableFrame(body,width=165,fg_color=INSET,corner_radius=0,border_width=1,border_color=LINE,scrollbar_button_color=LINE)
    ...
    def select(self,ident):
        ...
        restore=ctk.CTkSwitch(self.body,text='작업을 마치면 게임 절전 모드로 복귀',variable=self.restore,font=font(11),progress_color=ACCENT,button_color=CREAM)
