...
class DailyActions(DailyExecution):
        ...
        if key in SWEEP_DUNGEONS:
            ...
            for _ in range(16):
                ...
                if self.daily_has(screen,'sweep_free_1') and self.daily_has(screen,'sweep_count_0'):
                    ...
                    if not self.daily_try_tap(screen,'sweep_action'):continue
            ...
            for _ in range(16):
                ...
                if self.daily_has(screen,'d_enter'):
                    if not self.daily_try_tap(screen,'d_enter'):continue
    ...
    def daily_guild_dungeon(self):
        ...
        for _ in range(12):
            ...
            if not self.daily_try_tap(screen,'guild_fight',required=(counter,)):continue
