...
class Device:
    ...
    def capture(self):
        ...
        im[85:107,735:807]=self.level*100
        return im
...
class Tests(unittest.TestCase):
    ...
    def test_lost_first_tap_retries_once(self):
        d,c,r=self.run_task('ranking',lost=1);self.assertEqual(d.claims,2);self.assertEqual(r,{'ranking':'collected'})
    def test_three_tap_limit(self):
        d,c,r=self.run_task('ranking',lost=99);self.assertEqual(d.claims,3);self.assertEqual(r,{'ranking':'attempted'})
