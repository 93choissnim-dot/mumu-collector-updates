...
for path in sorted((Path(__file__).parent/'exe_release').glob('review-*.png')):
    if path.name not in {'review-compact-680.png','review-single.png','review-empty.png','review-list.png','review-settings.png','review-settings-top.png','review-compact.png','review-paused.png','review-scaled.png','review-history.png'}:continue
