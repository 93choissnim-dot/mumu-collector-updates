...
def check(app,output):
    ...
    for widget in [app.start_button,app.once_button,app.inspect_button]:
    ...
    from ui_theme import GameButton, BG, TEXT, ACCENT, CREAM
    ...
    assert app.start_button.cget('text_color')==CREAM
    for scale in (1.25,1.5):
        ...
        for widget in [app.start_button,app.once_button,app.update_button,app.more_button]:
    ...
    assert not app.once_button.winfo_ismapped() and not app.start_button.winfo_ismapped()
    ...
    for geometry in ('680x430+0+0','820x520+0+0'):
        ...
        assert not app.roster_panel.winfo_ismapped() and not app.fleet_bar.winfo_ismapped()
        for widget in (app.start_button,app.once_button,app.inspect_button,app.history_button):
