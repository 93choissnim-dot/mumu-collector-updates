...
class App(FleetCollection, FleetUI, Dashboard, Updates, RunControls, RosterUI):
    ...
    def save(self):
        ...
        value={**self.config,"adb_path":self.adb_path.get(),"address":self.address.get(),"serial":self.chosen_serial(),
               ...
               "restore_sleep":self.config.get("restore_sleep",True),"players":self.players,"stop_hotkey":self.stop_hotkey.value,
