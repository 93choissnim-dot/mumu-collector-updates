...
class Dashboard:
    def build(self):
        ...
        width=max(1040,min(1220,int(self.root.winfo_screenwidth()/scale)-60))
        height=max(680,min(820,int(self.root.winfo_screenheight()/scale)-85))
        self.root.geometry(f'{width}x{height}');self.root.minsize(1040,680)
        ...
        body.grid_columnconfigure(0,weight=1,minsize=515);body.grid_columnconfigure(1,weight=0,minsize=305);body.grid_rowconfigure(0,weight=1)
        ...
        tools=ctk.CTkFrame(roster,fg_color='transparent');tools.grid(row=1,column=0,sticky='ew',padx=14,pady=(0,10));tools.grid_columnconfigure(0,weight=1)
