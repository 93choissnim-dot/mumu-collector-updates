...
class PauseTests(unittest.TestCase):
    ...
    def test_reacquire_skips_completed_tasks_and_retains_click_budget(self):
        ...
        collector=SimpleNamespace(results={},claim_counts={},last_image=None,last_screen=None)
    ...
    def test_resumed_training_retains_three_attempt_limit(self):
        ...
        self.assertEqual(collector.claim_extra('training',None),'attempted')
