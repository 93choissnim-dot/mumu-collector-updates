...
RESULTS = {"collected": "수령 완료", "skipped": "수령할 자원 없음",
           "attempted": "수령 시도 · 완료 미확인", "unrecognized": "버튼 미인식 · 확인 필요",
           "failed": "진행 중단 · 확인 필요",
           "already_complete": "이미 완료", "already_claimed": "이미 수령", "no_entries": "입장 횟수 없음"}
TERMINAL_RESULTS=frozenset(("collected","skipped","already_complete","already_claimed","no_entries"))
ISSUES={'failed','attempted','unrecognized'}
...
class History:
    ...
    def record(self, serial, room, result, now=None, reason=None):
        ...
        with self.lock:
            ...
            rooms[room] = {"checked_at": stamp, "result": result,
