...
class Device:
    ...
    def screen(self):
        keys={}
        if self.state=='main':keys={'main_menu':(919,28),'top_event':(652,28)}
        elif self.state=='menu':keys={'menu_farm':(800,150),'menu_wood':(800,210),'menu_mine':(800,270),'sleep_menu':(830,490),'top_event':(652,28)}
    ...
    def click(self,point):
        ...
        elif self.state in {'main','menu'} and point==(652,28):self.state='event_menu'
