...
DAILY_LABELS={'daily_pass':'패스 수령','daily_dungeons':'일일 던전','daily_guild':'길드'}
# Top-bar pages first, then one menu group, ending beside the sleep control.
REGULAR_ORDER=('worldboss','autumn','ranking','excavation','training','mine','wood','farm')
REGULAR_LABELS={key:({**LABELS,**EXTRA_LABELS})[key] for key in REGULAR_ORDER}
BASE_TASKS=frozenset(('worldboss','autumn',*DAILY_LABELS))
TASK_LABELS={**REGULAR_LABELS,**DAILY_LABELS}
PAGE_MARKERS={
